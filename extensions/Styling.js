...
define(["dojo/_base/lang",
	...
	lang.extend(Tree, {
		...
		_getClassOrStyle: function (/*data.item*/ item, /*String*/ attr, /*String*/ type) {
			...
			throw new TypeError(this.moduleName+"::_getClassOrStyle(): invalid attribute type specified.");
		},
		...
		_getItemStyling: function (item) {
			...
			throw new TypeError(this.moduleName+"::getItemStyling(): invalid data item specified.");
		},
		...
		_setAttrClass: function (/*data.item?*/ item, /*String*/ attr, /*String*/ cssClass,
			...
			if (typeof cssClass === "string") {
				...
				throw new TypeError(this.moduleName+"::setItemClass(): invalid attribute specified.");
			}
			throw new TypeError(this.moduleName+"::setItemClass(): invalid argument type specified.");
		},
		...
		_setAttrStyle: function (/*data/item*/ item, /*String*/ attr, /*Object*/ style, /*Function*/ onComplete) {
			...
			if (lang.isObject(style)) {
				...
				throw new TypeError(this.moduleName+"::setItemStyle(): invalid attribute specified.");
			}
			throw new TypeError(this.moduleName+"::setItemStyle(): invalid argument type specified.");
		},
			...
			if (isObject(map)) {
				...
				for (prop in map) {
					if (isObject(map[prop])) {
						...
						throw new TypeError(this.moduleName+"::_setValueToIconMap(): invalid property value type.");
					}
				}
			} else {
				map = null;
			...
			if (model) {
				...
				if (model.iconAttr) {
					if (!model.getIcon || typeof model.getIcon != "function") {
						console.warn("cbtree/extensions/Styling::_connectModel(): model has 'iconAttr' set but does not provide support for getIcon().");
						this._iconAttr = null;
					} else {
			...
			if (icon) {
				if (!isObject(icon)) {
					if (typeof icon === "string" && icon.length) {
						...
						throw new TypeError(this.moduleName+"::_icon2Object(): icon must be an object or string");
					}
				} else {
					...
					throw new Error(this.moduleName+"::_icon2Object(): required property 'iconClass' is missing or empty");
				}
			}
			return null;
		},
