...
define([
  ...
  lang.extend(Tree, {
    ...
    getIconClass: function (/*data.item*/ item, /*Boolean*/ opened, /*_TreeNode?*/ nodeWidget) {
      ...
      // nodeWidget:
      //    Tree node. (only available when called from a tree node).
      // returns:
      ...
      if (!itemIcon.iconClass) {
        ...
        iconClass = nodeWidget ? domProp.get(nodeWidget["iconNode"], "className") : "";
        iconClass = iconClass ? iconClass + ' ' + newClass : newClass;
        return iconClass;
      }
      // Handle custom icons...
