define("dojo/_base/declare"], function (declare) {
  ...
  declare(null, {
    ...
    getIdentity: function (item) {
      ...
      // item: Item
      // returns: dojo/promise/Promise | String | Number
      //    If a promise is returned, the promise should resolve to either a
      //    String or a Number
      // tags:
      //    Public
      throwAbstract();
    ...
    validateData: function () {
      ...
      //    This method is required if a strict parent-child relationship is to
      //    be maintained.
      //  tag:
      //    Public, Optional
    },
